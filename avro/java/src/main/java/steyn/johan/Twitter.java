...
public class Twitter extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static BinaryMessageDecoder<Twitter> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<Twitter>(MODEL$, SCHEMA$, resolver);
  }
  ...
  /** Name of the user account on Twitter */
   ...
   * @param username Name of the user account on Twitter
   * @param tweet The content of the user's Twitter message
   * @param timestamp Unix epoch time in seconds
   */
  public Twitter(java.lang.CharSequence username, java.lang.CharSequence tweet, java.lang.Long timestamp) {
   ...
   * @return Name of the user account on Twitter
   */
   ...
   */
  public static steyn.johan.Twitter.Builder newBuilder() {
    return new steyn.johan.Twitter.Builder();
  }
   ...
   * @return A new Twitter RecordBuilder
   */
  public static steyn.johan.Twitter.Builder newBuilder(steyn.johan.Twitter.Builder other) {
    if (other == null) {
      return new steyn.johan.Twitter.Builder();
    } else {
      return new steyn.johan.Twitter.Builder(other);
    }
  }
   ...
   * @return A new Twitter RecordBuilder
   */
  public static steyn.johan.Twitter.Builder newBuilder(steyn.johan.Twitter other) {
    if (other == null) {
      return new steyn.johan.Twitter.Builder();
    } else {
      return new steyn.johan.Twitter.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Twitter>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(steyn.johan.Twitter.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(steyn.johan.Twitter other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.username)) {
        this.username = data().deepCopy(fields()[0].schema(), other.username);
    ...
    /**
      ...
      * @return This builder.
      */
    public steyn.johan.Twitter.Builder setUsername(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public steyn.johan.Twitter.Builder clearUsername() {
      username = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public steyn.johan.Twitter.Builder setTweet(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public steyn.johan.Twitter.Builder clearTweet() {
      tweet = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public steyn.johan.Twitter.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public steyn.johan.Twitter.Builder clearTimestamp() {
